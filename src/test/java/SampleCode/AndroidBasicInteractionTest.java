...
public class AndroidBasicInteractionTest extends BaseTest {
    ...
    public void setUp() throws IOException {
        ...
        File app = new File(classpathRoot.getCanonicalPath(), "ApiDemos-debug.apk");
    ...
    public void test()
    {
        driver.startActivity(new Activity(this.PACKAGE,this.SEARCH_ACTIVITY));
        AndroidElement searchBoxEl =
                (AndroidElement)driver.findElementById("txt_query_prefill");
